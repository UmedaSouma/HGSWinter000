...
{
	{"assets\\sounds\\gameBGM200.wav", -1, 1.0f},	// SOUND_LABEL_MAIN_BGM
};
...
HRESULT PlaySound(SOUND_LABEL label)
{
	...
	// 音量取得
	g_apSourceVoice[label]->SetVolume(g_aSoundInfo[label].fVolume);
...
// 音量の設定
//=============================================================================
void SetVolumeSound(SOUND_LABEL label, float fVolume)
{
	g_aSoundInfo[label].fVolume = fVolume;	// 音量の更新
	// 音量の設定
	g_apSourceVoice[label]->SetVolume(g_aSoundInfo[label].fVolume);
}
